...
public abstract class AbstractDAOTest {
    ...
    <div>另外，别忘了sqlmap-config.xml的配置！欢迎参与项目<a href="http://www.github.com/elricboa/code-generator/">http://www.github.com/elricboa/code-generator/</a>，更多功能敬请期待！</div>
</div><!-- /box -->
